...
class AddNoteModal extends Component {
    render() {
        return (
                <div className={'AddNoteModal note-modal-inactive '+ returnTheme() + '-t-modal'}>
                    <div className="modal-w">
                        <h1 className={"head-w "+ returnTheme() + "-t-text-w"}>New Note</h1>

                        <div className="field-w">
                            <label className={"label-w "+ returnTheme() + "-t-text-w"}>Note Name</label>
                        ...
                        <div className="field-w">
                            <label className={"label-w "+ returnTheme() + "-t-text-w"}>Note Content</label>
                    ...
                    <div className="btn-container-w">
                        <div onClick={this.storeNote} className={"btn-w "+ returnTheme() + "-t-btn-w f-w"}>Add Note</div>
                    </div>
                </div>
        );
    }
